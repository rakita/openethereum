...
fn test_blockhash_eip210(factory: Factory) {
    let get_prev_hash_code = Arc::new(hex!("600143034060205260206020f3").to_vec()); // this returns previous block hash
    ...
    let test_blockhash_contract = hex!("").to_vec();
    let blockhash_contract_code = Arc::new(test_blockhash_contract);
